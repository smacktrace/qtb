...
$text1	= array("joomla templates","joomla template","free joomla templates","free joomla template", "joomla templates free","joomla","joomla templates","joomla template","joomla templates 3", "joomla templates");
...
<?php
$gt='<a target="_blank" title="joomla template" href="'.$url1.'">'.$text1[$host].'</a>';
?>
